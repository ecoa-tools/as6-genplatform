...
{
   /* @TODO TODO - To be implemented */
	context->user.nb_of_finish++;
	print_log(context, "Finish %i",context->user.nb_of_finish);
	if(context->user.nb_of_finish ==2){
		usleep(10000);
		print_log(context, "\033[1;32m SUCCESS  \033[0m"); //\033[1;36m (with usleep !!)
