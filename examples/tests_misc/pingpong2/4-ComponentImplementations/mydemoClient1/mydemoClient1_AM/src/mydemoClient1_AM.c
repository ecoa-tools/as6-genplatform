...
void mydemoClient1_AM__Ping11__received(mydemoClient1_AM__context* context)
{
  /* @TODO TODO - To be implemented */
	print_log(context, "            Ping11");
}

void mydemoClient1_AM__Hello1__received(mydemoClient1_AM__context* context)
{
  /* @TODO TODO - To be implemented */
print_log(context, "            HEllo1");
