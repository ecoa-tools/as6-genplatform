...
#if !defined(_MYDEMOSERVER_AM_USER_CONTEXT_HPP)
#define _MYDEMOSERVER_AM_USER_CONTEXT_HPP
...
/*Container types*/
/* #include "mydemoServer_AM_container_types.h" */

namespace mydemoServer_AM
{
...
#endif /* MYDEMOSERVER_AM_USER_CONTEXT_HPP */